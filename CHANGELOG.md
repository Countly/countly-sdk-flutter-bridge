...
* !! Major breaking change !! The minimum supported Flutter version is raised from 2.0.0 to 3.24.0 and the minimum Dart SDK version from 2.12.0 to 3.5.0. Swift Package Manager has been supported since 26.1.1, but CocoaPods was available alongside it. Now that CocoaPods is gone, Swift Package Manager is the only iOS integration path, and Flutter 3.24.0 is the first release that provides it.
