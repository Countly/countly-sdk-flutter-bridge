...
/// 3.Test Visibility Tracking - Test that the SDK handles visibility properly when initialized in background and event is recorded in the foreground
void main() {
  IntegrationTestWidgetsFlutterBinding.ensureInitialized();
  testWidgets('3.Test Visibility Tracking - Test that the SDK handles visibility properly when initialized in background and event is recorded in the foreground', (WidgetTester tester) async {
