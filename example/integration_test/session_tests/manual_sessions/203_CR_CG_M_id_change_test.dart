...
void main() {
  ...
  testWidgets('203_CR_CG_M_id_change', (WidgetTester tester) async {
    ...
    for (var element in requestList) {
      ...
      if (i == 0 || (Platform.isAndroid && i == 5) || (Platform.isIOS && i == 6)) {
        // example:
      ...
      } else if (i == 3 || (Platform.isAndroid && i == 6) || (Platform.isIOS && i == 7)) {
        expect(queryParams['begin_session']?[0], '1');
      } else if ((Platform.isIOS && (i == 4 || i == 8)) || (Platform.isAndroid && (i == 3 || i == 7))) {
        expect(queryParams['end_session']?[0], '1');
        expect(queryParams['session_duration']?[0], '2');
      } else if ((Platform.isIOS && (i == 5 || i == 9)) || (Platform.isAndroid && (i == 4 || i == 8))) {
