...
/// 7.Check if enableTemporaryDeviceIDMode() sets the device ID correctly before init
void main() {
  IntegrationTestWidgetsFlutterBinding.ensureInitialized();
  testWidgets('7.Check if enableTemporaryDeviceIDMode() sets the device ID correctly before init', (WidgetTester tester) async {
    // Initialize the SDK
