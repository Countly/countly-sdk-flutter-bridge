...
/// 6.Check if the SDK generates a device ID and the type is SDK_GENERATED using the new module
void main() {
  IntegrationTestWidgetsFlutterBinding.ensureInitialized();
  testWidgets('6.Check if the SDK generates a device ID and the type is SDK_GENERATED using the new module', (WidgetTester tester) async {
    // Initialize the SDK
