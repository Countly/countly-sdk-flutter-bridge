...
void main() {
  ...
  testWidgets('', (WidgetTester tester) async {
    // Initialize the SDK
    CountlyConfig config = CountlyConfig(SERVER_URL_RC, APP_KEY_RC).setLoggingEnabled(true).enableRemoteConfigAutomaticTriggers().setRequiresConsent(true).remoteConfigRegisterGlobalCallback(rcCallback).giveAllConsents();
    ...
    Countly.removeConsent([CountlyConsent.remoteConfig]);
