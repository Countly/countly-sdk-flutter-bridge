...
void main() {
  ...
  testWidgets('rc_ab tests with CR_CG_C', (WidgetTester tester) async {
    rcCounter = 0;
    rcCounterInternal = 0;
    // Initialize the SDK
    ...
    await Future.delayed(Duration(seconds: 3));
    await getAndValidateAllRecordedRCValues(isCurrentUsersData: trueForIOS); // TODO: rc erased here
    ...
    Countly.changeDeviceId("merge_id", true);
    await Future.delayed(Duration(seconds: 3));
    await getAndValidateAllRecordedRCValues(isCurrentUsersData: falseForIOS);
